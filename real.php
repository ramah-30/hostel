...
<nav class="navbar navbar-expand-md bg-primary fixed-top">
    ...
    <div class="d-flex align-items-center">
      <!-- Sign In button -->
      <a href="SignIn.php" class="btn btn-light btn-sm me-2 d-md-none">Sign In</a>
      ...
      <div class="offcanvas offcanvas-end  text-center" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
        ...
        <div class="offcanvas-body ">
          ...
          <ul class="navbar-nav nav-underline justify-content-end align center flex-grow-1 pe-3">
            ...
            <li class="nav-item d-none d-md-inline mx-2">
    ...
    <div class="container-md">
        ...
        <div class="col-8 col-md-6 col-lg-4 my-4 ">
          ...
          echo'
              ...
              <div class="d-flex justify-content-between">
                <a href="student/viewProperty.php?id='.$row2["Id"].'" class="btn btn-outline-primary btn-sm">View Details</a>
                <a href="student/bookProperty.php?id='.$row2["Id"].'"  class="btn btn-primary btn-sm">Book Now</a>
              </div>
            </div>
            <!-- Card Footer-->
      ...
      ?>
       ...
       <div class="d-flex justify-content-center m-5">
          <a href="student/rental.php" class="btn btn-lg btn-light text-primary border-primary rounded-5">View More</a>
        </div>
      </div>
  </section>
